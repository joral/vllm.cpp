...
| Quantized inference | Available for the formats and backends listed in Features | Block-wise FP8 matches the CPU reference on seven GB10 shapes, but has no model token gate or speed result; unsupported format/backend pairs refuse or fall back as documented (#1437). ROCm GGUF keep-quant is gfx1200-gated for four k-quants and its speed axis is open and currently unfavourable (#1506, #487, #1294) |
